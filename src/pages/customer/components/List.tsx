...
function List() {
  ...
  useEffect(() => {
    dispatch(CustomerActions.default.getList());
  }, [dispatch]);

  function handleDelete(id: string) {
    dispatch(CustomerActions.default.deleteRemove(id));
  }
            ...
            <tr key={index}>
              ...
              >
                <Link
                  ...
                  to={`${path.customerSet.path}/${item._id}`}
                >
                ...
                >
                  <i className="menu-icon fa fa-lock"></i>
                </button>
              </td>
            </tr>
          ))}
